...
pub fn constants() -> HashMap<String, Value> {
    HashMap::from([
        ...
        (String::from("NUM")   , Value::create(ValueType::Number as i64)),
        (String::from("STR")   , Value::create(ValueType::String as i64)),
        (String::from("ARR")   , Value::create(ValueType::Array  as i64)),
        (String::from("LEXPR") , Value::create(ValueType::LazyExpression as i64)),
        (String::from("FUNC")  , Value::create(ValueType::Function as i64)),
        (String::from("CLS")   , Value::create(ValueType::Class  as i64)),
