use crate::public::std::modules::{array, basic, math, string};
use crate::public::std::StdModules;
use crate::public::value::value::{Overload, Value};

use super::scope::Scope;

pub fn resolve(target_module: &StdModules, scope: &mut Scope) {
    match target_module {
        StdModules::Basic => {
        ...
        StdModules::Math => {
            ...
            scope
                .global
                .variables
                .insert(String::from("Math"), Value::create(module_obj));
        }
        StdModules::Array => {
            ...
            scope
                .global
                .variables
                .insert(String::from("Array"), Value::create(module_cls));
        }
        StdModules::String => {
            ...
            scope
                .global
                .variables
                .insert(String::from("String"), Value::create(module_cls));
        }
