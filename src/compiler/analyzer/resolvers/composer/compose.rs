...
use super::{assignment, object_reading, invocation};
    ...
    if is_more_token {
        ...
        match next_token {
            Token::Paren(Paren::LeftParen) => {
                ...
                let mut invoke_node =
                    invocation::resolve(var_node.clone(), tokens)?;
            ...
            Token::Symbol(Symbols::ObjectReading) => {
                ...
                let current_node =
                    object_reading::resolve(var_node, tokens)?.into();
